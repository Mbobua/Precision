                                ...
                                <div
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                        <span style="font-size: 18px; line-height: 28.8px;">Your ticket request<strong> (Ticket ID-#{{$ticket->id}}) </strong>has been <strong>resolved</strong>. The ticket status now stands as <strong>{{$ticket->status->name}}</strong>.</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                        <span style="font-size: 18px; line-height: 28.8px;">Please take a minute to leave us your candid feedback so we can continue to improve. Don't hold back, we want to know what you really think. Thank you!.</span>
                                                    </p>
                                                </div>
                                  ...
                                  <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                          style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                  style="line-height: 19.2px; font-size: 16px;">Click to Rate!</span></strong>
                                  </span>
                                  </span>
                                                    </a>
