                            ...
                            <div class="col-md-3 mb-4 stretch-card transparent">
                                <div class="card card-tale">
                                    <div class="card-body">
                                        ...
                                        <p class="fs-30 mb-2">{{ count($temporarily_solved) + count($in_progress) + count($new) + count($cancelled) +count($archived) +count($open) +count($solved) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4 stretch-card transparent">
                            ...
                            <div class="col-md-3 mb-4 stretch-card transparent">
                                <div class="card card-light-blue">
                                    <div class="card-body">
                                        ...
                                        <p class="fs-30 mb-2">{{ count($temporarily_solved) + count($in_progress) + count($on_hold) + count($reopened) +count($open) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4 stretch-card transparent">
                                <div class="card card-light-danger">
                                    <div class="card-body">
                                        <p class="mb-4">Cancelled tickets</p>
                                        <p class="fs-30 mb-2">{{ count($cancelled) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="example3" class="table table-striped">
                                ...
                                @foreach($new as $ticket_id)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('employee.ticket-detail', $ticket_id)}}"
