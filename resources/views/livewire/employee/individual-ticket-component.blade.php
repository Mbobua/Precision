<div>
    ...
    <div class="col-12 grid-margin">
        ...
        @if( $ticketItem->status->name == 'Solved' &&  $ticketItem->reopening_status == true)
                                                    ...
                                                    <div class="col-md-6 border-right">
                                                        <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                            ...
                                                            <table class="table table-borderless report-table">
                                                                ...
                                                                @if($ticketItem->rstatus == 1)
                                                                    <tr>
                                                                        <td class="text-muted">Rating</td>
                                                                        <td class="">
                                                                            <h6 class="font-weight-500"
                                                                                style="font-size: medium">{{ $ticketItem->review->rating }}*</h6>
                                                                        </td>
                                                        ...
                                                        <div class="col-md-12 border-right border-danger">
                                                            <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                                ...
                                                                <blockquote class="blockquote blockquote-success">
                                                                    <p style="text-align: justify">{{ $ticketItem->review->comment }}</p>
                                                                    <footer
                                                                        class="blockquote-footer">{{  $ticketItem->requester->name }}</footer>
                                                                </blockquote>
                                                            </div>
            ...
            <div class="modal fade" id="ticketModal" tabindex="-1" role="dialog" aria-labelledby="ticketModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('employee.ticket.rating') }}" method="post">
                            @csrf
