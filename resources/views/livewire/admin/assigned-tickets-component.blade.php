                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active " id="open" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="dt9" class="table table-striped">
                                        <thead>
                                        <tr>
                            ...
                            <div class="tab-pane fade" id="re-opened" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="dt10" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
                            ...
                            <div class="tab-pane fade" id="in-progress" role="tabpanel"
                                 aria-labelledby="in-progress-tab">
                                <div class="table-responsive">
                                    <table id="dt11" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
                            ...
                            <div class="tab-pane fade" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                                <div class="table-responsive">
                                    <table id="dt12" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
                            ...
                            <div class="tab-pane fade" id="partially-solved" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="dt13" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
                            ...
                            <div class="tab-pane fade" id="solved" role="tabpanel" aria-labelledby="solved-tab">
                                <div class="table-responsive">
                                    <table id="dt14" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
                            ...
                            <div class="tab-pane fade" id="cancelled" role="tabpanel" aria-labelledby="cancelled-tab">
                                <div class="table-responsive">
                                    <table id="dt15" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
                            ...
                            <div class="tab-pane fade" id="archived" role="tabpanel" aria-labelledby="archived-tab">
                                <div class="table-responsive">
                                    <table id="dt16" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th class="text-primary">
                                                T-ID
