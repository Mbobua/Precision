                                                    ...
                                                    <div class="col-md-6 border-right">
                                                        <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                            ...
                                                            <table class="table table-borderless report-table">
                                                                ...
                                                                @if($ticket->rstatus == true)
                                                                    <tr>
                                                                        <td class="text-muted">Ticket Rating</td>
                                                                        <td class="">
                                                                            <h6 class="font-weight-500"
                                                                                style="font-size: medium">{{ $ticket->rstatus }}</h6>
                                                                        </td>
                                                                    </tr>
                                                                @endif
                                                        ...
                                                        <div class="col-md-12 border-right border-danger">
                                                            <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                                ...
                                                                <blockquote class="blockquote blockquote-success">
                                                                    <p style="text-align: justify">{{ $ticket->review->comment ?? 'No comment/feedback available' }}</p>
                                                                    <footer
                                                                        class="blockquote-footer">{{  $ticket->requester->name }}</footer>
                                                                </blockquote>
                                                            </div>
