...
class AssignedTicketsComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.admin.assigned-tickets-component', compact('unsolved_tickets', 'solved_tickets', 'myassignedtickets', 'open', 'in_progress', 'on_hold', 'temporarily_solved', 'cancelled', 'solved', 'archived', 'reopened'))->layout('layouts.support-admin-dashboard');
    }
